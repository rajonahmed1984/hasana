...
<div id="page-content-wrapper">
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fs-2 m-0">ব্র্যান্ড তালিকা</h2>
        </div>
    </nav>
    ...
    <div class="container-fluid px-4">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0"><i class="fas fa-list-ul me-2 accent-text"></i>সকল ব্র্যান্ড</h4>
                <div>
                    <a class="btn btn-primary btn_modal" href="{{ route('brands.create')}}">
                        <i class="fas fa-plus-circle me-2"></i>নতুন ব্র্যান্ড যোগ করুন
                    </a>
                </div>
            </div>
